...
before packages are loaded."
  ...
  ;; Line insertion.
  (global-set-key (kbd "S-<return>") 'spacemacs/evil-insert-line-below)
  (global-set-key (kbd "M-S-<return>") 'spacemacs/evil-insert-line-above)
